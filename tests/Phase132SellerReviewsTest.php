...
$root=dirname(__DIR__);$service=file_get_contents($root.'/app/Services/SellerReviewService.php');$migration=file_get_contents($root.'/database/migrations/2026_09_18_phase_13_2_seller_reviews.sql');$buyer=file_get_contents($root.'/app/Controllers/BuyerController.php');$controller=file_get_contents($root.'/app/Controllers/ReviewController.php');$public=file_get_contents($root.'/app/Views/public/store.php');$routes=file_get_contents($root.'/public/index.php');
$checks=[
 'one Phase 13.2 migration'=>count(glob($root.'/database/migrations/*phase_13_2*'))===1,
