...
### Phase 12.6 — Custom Design Listings & Orders
- Added approved-seller custom service listings, validated buyer briefs and reference uploads, Stripe-backed orders, linked messaging, proof/revision/final delivery, protected access, notifications, and admin visibility without mixing services into normal products.
