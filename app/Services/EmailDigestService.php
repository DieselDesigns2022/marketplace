...
final class EmailDigestService
{
    ...
    {
        $groups=[];
        foreach($products as $product)$groups[(int)$product['designer_id']][]=$product;
        $result=[];
