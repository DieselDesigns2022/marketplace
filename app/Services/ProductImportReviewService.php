...
class ProductImportReviewService
{
    public const LABELS=[
        ...
        'licenses'=>'Review and explicitly configure Creative Moth licenses.',
        'fulfillment'=>'Review and explicitly choose Creative Moth fulfillment/delivery.',
        'price'=>'Review and explicitly save a valid Creative Moth price.',
        'source_type'=>'Review source product type and configure an eligible Creative Moth delivery method.',
    ];
