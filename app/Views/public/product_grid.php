...
<article class="card product">
    ...
    <a href="/product/<?=H::e($p['slug'])?>" class="product-meta"><p><strong><?=H::money($p['price'])?></strong></p><span class="badge ai"><?=H::e($p['ai_disclosure'])?></span> <span class="badge <?= $p['pod_allowed'] ? 'ok' : 'no' ?>"><?= $p['pod_allowed'] ? 'POD allowed' : 'No POD' ?></span></a>
</article>
<?php endforeach; ?>
</div>
