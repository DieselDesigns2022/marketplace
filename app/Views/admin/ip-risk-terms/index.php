...
<?php if(H::canAdmin('ip_risk.manage')):?><p><a class="btn" href="/admin/ip-risk-terms/create">Create IP Risk Term</a></p><?php endif;?>
<table>
    ...
    <?php foreach ($terms as $term): ?>
        <tr>
            ...
            <td>
                <?php if(H::canAdmin('ip_risk.manage')):?><a href="/admin/ip-risk-terms/<?=$term['id']?>/edit">Edit</a>
