...
<p class="notice">
    <?=$hasProof
        ?'Proof approved. Waiting for the seller to deliver the final design.'
        :'The seller is currently working on your Custom Design.'?>
</p>
<?php elseif(!$sellerView&&$order['status']==='revision_requested'):?>
<p class="notice">
    Your revision request was sent. Waiting for the seller to begin the revision.
</p>
<?php elseif(!$sellerView&&$order['status']==='completed'):?>
<p class="notice success">
    Your final design has been delivered. Download it above under Protected files.
</p>
<?php elseif(in_array($order['status'],['cancelled','refunded'],true)):?>
<p class="notice warning">
    This custom order is <?=H::e(str_replace('_',' ',$order['status']))?>.
</p>
