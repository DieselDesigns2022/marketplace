    ...
    <table>
        ...
        <?php foreach($items as $p):?>
           <tr>
             ...
             <td><?=H::e($p['fulfillment_label'] ?? 'Downloadable Product')?><?php if(($p['fulfillment_type'] ?? '')==='google_drive' && !empty($p['manual_delivery_instructions'])):?><br><span class="muted"><?=H::e($p['manual_delivery_instructions'])?></span><?php endif;?></td>
