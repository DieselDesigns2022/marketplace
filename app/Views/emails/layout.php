...
<img src="<?=H::e(H::assetUrl('assets/img/creative-moth-logo.png'))?>" alt="Creative Moth" width="220" style="display:block;margin:0 auto;max-width:220px;width:100%;height:auto;border:0;">
</a>
</td></tr>
<tr><td><?=$content?></td></tr>
<tr><td style="padding:24px 28px;background:#fffafc;border-top:4px solid #67e8c9;text-align:center;font-size:12px;line-height:1.6;color:#6b6478;">Made for creative people and independent designers.<br>Creative Moth · <a href="<?=H::e(H::baseUrl())?>" style="color:#6d28d9;">Visit the marketplace</a></td></tr>
