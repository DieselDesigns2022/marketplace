...
<?php if(!empty($collabSales)):?><section><h2>Collab Bundle earnings</h2><div class="responsive-table"><table><tr><th>Collab / order</th><th>Buyer</th><th>Sale basis</th><th>Your allocation</th><th>Refunded allocation</th><th>Payout</th><th>Date</th></tr><?php foreach($collabSales as $sale):?><tr><td><?=H::e($sale['title'])?> · #<?=(int)$sale['order_id']?></td><td><?=H::e($sale['email'])?></td><td><?=H::money($sale['gross_basis_cents']/100)?></td><td><?=H::money($sale['allocation_cents']/100)?></td><td><?=H::money($sale['refunded_allocation_cents']/100)?></td><td><?=H::e(str_replace('_',' ',$sale['payout_status']??'pending'))?></td><td><?=H::e($sale['created_at'])?></td></tr><?php endforeach;?></table></div></section><?php endif;?>
