...
final class NotificationController {
 ...
 public function open($id):void { H::requireLogin();if(!ctype_digit((string)$id)||(int)$id<1)H::abort(404);$url=\App\Services\NotificationService::openForUser((int)$id,(int)H::user()['id'])??H::abort(404);H::redirect($url); }
