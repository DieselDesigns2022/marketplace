...
class PublicController
{
    ...
    public function store($slug)
    {
        ...
        H::view('public/store',['d'=>$d,'products'=>$products,'followers'=>$followerCount,'isFollowing'=>$isFollowing,'isOwner'=>$isOwner,'productCount'=>count($products),'salesCount'=>$d['sales_count']??array_sum(array_column($products,'sales_count')),'meta'=>['title'=>$title,'description'=>$description,'canonical'=>$canonical,'og_title'=>$title,'og_description'=>$description,'og_image'=>$d['banner_path'] ?: $d['avatar_path']]]);
