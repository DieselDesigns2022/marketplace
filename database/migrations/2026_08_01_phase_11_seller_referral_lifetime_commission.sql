...
DROP INDEX IF EXISTS seller_ref_commission_unpaid_idx ON seller_referral_commission_ledger;
CREATE INDEX seller_ref_commission_unpaid_idx ON seller_referral_commission_ledger(referral_id,payout_item_id,claimed_batch_id,created_at);
...
DROP INDEX IF EXISTS seller_ref_attempt_batch_idx ON seller_referral_transfer_attempts;
CREATE INDEX seller_ref_attempt_batch_idx ON seller_referral_transfer_attempts(batch_id,attempted_at);
