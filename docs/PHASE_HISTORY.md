...
## Phase 13.6 — Social Product Auto-Posting (2026-09-21)
Added encrypted independent Facebook Page, Instagram professional-account, and Pinterest connections; seller-controlled manual and one-time newly-published automatic product posting; preview/caption selection; Pinterest boards; durable attempt/failure logs and actionable notifications; OAuth state protection; and independent admin platform kill switches. External delivery remains dependent on configured, provider-approved applications.
